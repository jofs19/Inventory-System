...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Edit Item Page </h4><br><br>
 ...
 <form method="post" action="{{ route('product.update') }}" id="myForm" >
  ...
  <!-- end row -->
      ...
      <div class="row mb-3">
        <label class="col-sm-2 col-form-label">Offices Name </label>
        <div class="col-sm-10">
  ...
  {{-- <div class="row mb-3">
    <label for="example-text-input" class="col-sm-2 col-form-label">Input No. of Requestor Stocks </label>
    <div class="form-group col-sm-10">
        <input name="stock" value="{{ $product->stock }}" class="form-control" type="text"    >
    </div>
</div> --}}
<!-- end row -->
