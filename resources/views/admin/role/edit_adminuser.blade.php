...
<div class="col-12">
    ...
    <form method="post" action="{{ route('admin.user.update') }}" id="myForm" enctype="multipart/form-data" >
                @csrf


                <input type="hidden" name="id" value="{{ $adminuser->id }}">
                <input type="hidden" name="old_image" value="{{ $adminuser->profile_image }}">


            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Admin Name </label>
                <div class="form-group col-sm-10">
                    <input name="name" class="form-control" type="text"  value="{{ $adminuser->name }}" >
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="username" class="form-control" type="text"  value="{{ $adminuser->username }}"  >
                </div>
            </div>
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="phone" class="form-control" type="text"  value="{{ $adminuser->phone }}"  >
                </div>
            </div>
            <!-- end row -->
  ...
  <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="email" class="form-control" type="email" value="{{ $adminuser->email }}" >
                </div>
            </div>
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
       <input name="profile_image" class="form-control" type="file"  id="image" value="{{ $adminuser->profile_image }}">
                </div>
            </div>
            <!-- end row -->
...
<div class="col-md-4 ">
		...
		<div class="controls">
			...
			<fieldset>
				<input type="checkbox" id="checkbox_4" name="m_units" value="1" {{ $adminuser->m_units == 1 ? 'checked' : '' }}>
...
<div class="col-md-4">
		...
		<div class="controls">
			<fieldset>
				<input type="checkbox" id="checkbox_7" name="m_categories" value="1" {{ $adminuser->m_categories == 1 ? 'checked' : '' }}>
				<label for="checkbox_7">Manage Categories</label>
			</fieldset>
			<fieldset>
				<input type="checkbox" id="checkbox_8" name="m_products" value="1" {{ $adminuser->m_products == 1 ? 'checked' : '' }}>
...
<div class="col-md-4">
	<div class="form-group">
		...
		<div class="controls">
			...
			<fieldset>
				<input type="checkbox" id="checkbox_14" name="m_access" value="1" {{ $adminuser->m_access == 1 ? 'checked' : '' }}>
